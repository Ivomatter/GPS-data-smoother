...
raw_data = pd.read_csv('../producer/raw_gps.csv')
processed_data = pd.read_csv('processed_gps_data.csv')
...
map_obj_raw.save("raw_gps_data_map.html")
...
map_obj_processed.save("processed_gps_data_map.html")